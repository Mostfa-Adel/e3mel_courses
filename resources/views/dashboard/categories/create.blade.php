...
@section('content')
    <section class="create-form-style pt-3">
        ...
        <div class="row cards py-1">
            ...
            <a class=" d-flex flex-row-reverse card col-sm-2 col-md-2 col-lg-2 col-xl-1 btn btn-outline-primary text-center rounded pe-4 pe-xl-4 pe-lg-5 pe-sm-3"
                href="{{ route('categories.index') }}" class="btn btn-default">
                <span class="d-flex ">
                    @lang('flash.cancel')
